...
<template>
  <section :class="css({
    ...
    ">
        <img alt="" :class="css({ w: 'full', h: 'full', objectFit: 'contain' })" loading="lazy"
    ...
    ">
        ...
        <div :class="css({ display: 'flex', mb: '4' })">
          <span :class="css({ display: 'flex', alignItems: 'center' })">
            <svg :fill="fillStar(n, product.rating)" stroke="currentColor" stroke-linecap="round"
              stroke-linejoin="round" stroke-width="2" :class="css({
    w: 5,
    h: 5,
    color: 'orange.500',
  })
    " viewBox="0 0 24 24" v-for="n in 5" :key="n">
